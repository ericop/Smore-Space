...
[Play S'more Space](https://ericop.github.io/Smore-Space/)
...
- `1 coin` to clean each campsite after use
- `2 coins` each week for office staff
- `2 coins` for every bathroom and shower in use
...
## Guest Demand And Weekly Variety
...
Open [index.html](C:\src\smoreSpace\index.html) in a browser.
...
- `Roadside Retreat`
- `Pitch Perfect Park`
- `The Great Campout Builder`
- `Trails, Tiles & Campfires`
