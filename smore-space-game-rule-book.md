# S'more Space Rule Book

This rule book is based only on the current contents of `smore-space.js`.
It describes what the JavaScript game file appears to implement right now, not the full intended tabletop design.

## Game Overview

In S'more Space, 2 to 5 players build personal campgrounds over multiple years. Players spend cash during an off-season building phase to place polyomino-style campground tiles on an 8 by 16 personal board. When every player has passed for the round, the game shifts into camping season, where communal arrival cards generate income for any players whose campground layout and amenities qualify.

The game lasts **5 rounds**, which are framed as **5 years**. The winner is the player with the most cash at the end of the fifth year.
...
- a name
- a personal **8 x 16 campground grid**
- **$10 starting cash**
- a `passedThisRound` status used during the building phase
